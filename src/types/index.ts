...
export const MILKING_MAP: Record<string, string> = { '1': 'Low Prod', '2': 'Med Prod', '3': 'High Prod', '4': 'Recovery' }
export const BARN_NAMES = ['Bulunde A', 'Bulunde B', 'Tezengwa A', 'Tezengwa B', 'Ushirika A', 'Ushirika B', 'Mwalesela A', 'Mwalesela B', 'Kashishi A', 'Kashishi B'] as const
